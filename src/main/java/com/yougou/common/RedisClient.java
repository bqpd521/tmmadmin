...
import com.yougou.common.RedisClient2.ListTranscoder;
...
public class RedisClient {
    ...
    private String redisHost="10.10.10.143";  //需要把这些参数放在配置文件里面，暂时先这样 127.0.0.1
    ...
    private void initialShardedPool(){ 
        ...
        shards.add(new JedisShardInfo(redisHost, redisPort, "master")); 
    ...
    /**
     * 方法说明：测试方法
     * 创建时间：2014年9月29日 上午10:44:25  Yin yunfei
     */
    ...
    public static void main3(String [] args){
        ...
        System.out.println(rClient.jedis.flushDB()); 
        
        List<String> tempList22 = new ArrayList<String>();
        tempList22.add("aaa");
        tempList22.add("bbb");
        byte [] tempByte=ListTranscoder.serialize(tempList22);
        System.out.println("=============增=============");
        System.out.println("hashs中添加key001和value001键值对："+rClient.shardedJedis.hset("hashs", "key001", "value001")); 
        System.out.println("hashs中添加key002和value002键值对："+rClient.shardedJedis.hset("hashs", "key002", "value002")); 
        System.out.println("hashs中添加key003和value003键值对："+rClient.shardedJedis.hset("hashs", "key003", "value003"));
        System.out.println("新增key004和4的整型键值对："+rClient.shardedJedis.hincrBy("hashs", "key004", 4l));
        System.out.println("hashs中的所有值："+rClient.shardedJedis.hvals("hashs"));
        System.out.println();
    }
...
//		
//	    rClient.KeyOperate();
	    //rClient.StringOperate();
		
//		List<String> tempList=new ArrayList<String>();
//		tempList.add("yinyf");
//		byte [] tempByte=ListTranscoder.serialize(tempList);
//		String key1="abcd";
//		rClient.jedis.set(key1.getBytes(), tempByte);
//		
//		byte[] in = rClient.jedis.get(key1.getBytes()); 
//		
//		if(in!=null){
//			
//			List<String> tempList2=(List<String>)ListTranscoder.deserialize(in); 
//			
//			System.out.println(tempList2.get(0));
//		}
		
//		AdminUserModel al=new AdminUserModel();
//		al.setUserAccount("s");
//		
//		Map<String,AdminUserModel> userMap=new HashMap<String,AdminUserModel>();
//		userMap.put("name".getBytes(),al);
//		//userMap.put("pwd","password");
//        rClient.jedis.hmset("".getBytes(), userMap);
//        
//        //Map<String,String> userMap2=(HashMap<String,String>)rClient.jedis.get("aba");
//        System.out.println(rClient.jedis.hmget("aba", "name"));
	}
}
